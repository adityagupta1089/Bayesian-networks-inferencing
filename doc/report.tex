...
\begin{tikzpicture}
    \datavisualization [scientific axes,
    						 x axis={logarithmic,length=12cm,label=Value of \texttt{SAMPLE\_COUNT},grid},
     						 y axis={logarithmic,length=11cm,label=Total(Sum of) Error(s) in all Rejection Sampling Cases,grid},
